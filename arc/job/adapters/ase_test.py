...
from arc.job.adapters.scripts.ase_script import to_hartree, numpy_vibrational_analysis
...
class TestASEAdapter(unittest.TestCase):
    ...
    def test_to_hartree(self):
        """Test utility conversion function to_hartree"""
        self.assertAlmostEqual(to_hartree(1.0), 0.0367493, places=5)
        self.assertAlmostEqual(to_hartree(27.21138), 1.0, places=4)
