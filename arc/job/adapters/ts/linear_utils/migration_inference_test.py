...
class TestMigrationInferenceImports(unittest.TestCase):
    ...
    def test_private_helpers_re_export_identity(self):
        self.assertIs(legacy_lg._split_into_fragments,
                      mi._split_into_fragments)
        self.assertIs(legacy_lg._heavy_formula_of_fragment,
                      mi._heavy_formula_of_fragment)
        self.assertIs(legacy_lg._h_count_of_fragment,
                      mi._h_count_of_fragment)
