...
H      -3.45360689    0.15275707   -0.76116277""")
    ...
    def test_heuristics_for_h_abstraction_1(self):
        ...
        expected_xyz = {'symbols': ('C', 'H', 'H', 'H', 'H', 'H'), 'isotopes': (12, 1, 1, 1, 1, 1),
                        'coords': ((-0.09044150980502302, 0.053042021552394625, -3.3989957515245806e-09), (1.2201978239199354, 0.053041837183703644, -1.0612874579152276e-07), (-0.45450798624282407, -0.46182571409625733, -0.8917769835230851), (-0.45450798624282407, -0.46182571409625733, 0.891777212834642), (-0.45450798624282407, 1.082777469602218, 1.1817598899455106e-08), (1.2201976977702995, -0.8437301421482575, -9.45291477316701e-08))}
    ...
    def test_heuristics_for_h_abstraction_5(self):
        ...
        self.assertTrue(almost_equal_coords(rxn8.ts_species.ts_guesses[0].initial_xyz,
                                            {'symbols': ('N', 'C', 'O', 'N', 'H', 'H'),
                                             ...
                                             'coords': ((-3.6579485832738622e-09, -0.691630631762969, 0.4107159257234607), (-3.6579485832738622e-09, 0.4776334492042129, 0.4597246133145747), (9.610153000812125e-09, 1.650963102562542, 0.4784434925096499), (-3.6579485832738622e-09, -1.4752573190779947, -1.1409290611201306), (-3.6579485832738622e-09, -0.3063246655194316, -0.7543414784478815), (-3.6579485832738622e-09, -1.4752573190779947, -2.166929084008314))}))
        self.assertTrue(almost_equal_coords(rxn8.ts_species.ts_guesses[1].initial_xyz,
                                            {'symbols': ('N', 'C', 'O', 'N', 'H', 'H'),
                                             'isotopes': (14, 12, 16, 14, 1, 1),
                                             'coords': ((0.748727995761331, 0.47763491663667274, 0.053596050876045354), (-0.23224318585645598, 0.10467541708225353, 0.5714542312951174), (-1.2310939407099593, -0.26389287079976465, 1.06491898037513), (0.748727995761331, -0.305991770678353, -1.498048935967546), (0.748727995761331, 0.8629408828802101, -1.1114613532952968), (0.748727995761331, -0.305991770678353, -2.5240489588557296))}))
        self.assertTrue(almost_equal_coords(rxn8.ts_species.ts_guesses[2].initial_xyz,
                                            {'symbols': ('N', 'C', 'O', 'N', 'H', 'H'),
                                             'isotopes': (14, 12, 16, 14, 1, 1),
                                             'coords': ((-0.7487279943596638, 0.4776349234538972, 0.05359605313062632), (0.23224318725812287, 0.10467542389947732, 0.5714542335496988), (1.2310939370275031, -0.26389288870995853, 1.0649189744518992), (-0.7487279943596638, -0.30599176386112853, -1.498048933712965), (-0.7487279943596638, 0.8629408896974347, -1.1114613510407159), (-0.7487279943596638, -0.30599176386112853, -2.5240489566011486))}))
    ...
    def test_heuristics_for_h_abstraction_6(self):
        ...
        self.assertEqual(len(rxn9.ts_species.ts_guesses), 4)
        ...
        self.assertEqual(len(rxn10.ts_species.ts_guesses), 5)
    ...
    def test_heuristics_for_h_abstraction_13(self):
        ...
        heuristics_1.execute_incore()
        self.assertEqual(len(rxn1.ts_species.ts_guesses), 5)
    ...
    def test_combine_coordinates_with_redundant_atoms(self):
        ...
        expected_xyz = {
            ...
            'coords': ((1.2298958157747382, -0.12498251345269652, -2.785896657734001), (1.2298958157747382, -0.12498251345269652, -1.2711486804772263), (0.06964526723160169, 0.5686736984194414, -0.8153307154381972), (0.13611646007015654, 0.5287121260134585, 0.6385274660265261), (1.2298958157747382, 0.8998561069235966, -3.171611278948176), (2.1066755149899237, -0.6491564711282767, -3.1762681737219225), (0.3271595110717749, -0.6101278951711984, -3.1715727221995116), (2.1251077705417356, 0.37981912706619003, -0.8928501910303055), (1.209057583908099, -1.1525439830720967, -0.8929726359559111), (-0.8482845825272542, -0.08189314093299173, 0.7952207491151237), (-1.955447184629141, -0.8318072447823602, 2.110688842592648), (-0.6659055268451335, -0.04242739942412849, 2.09477946775868), (-2.2488160998962003, -1.068138395068081, 3.1378582921023512), (-1.8382212290671143, -1.7706269616125785, 1.5612432028786025), (-2.7627304388508156, -0.2586598105996549, 1.6450693275396575), (0.14137981713392422, -0.6155774052710343, 2.56040731991721), (-0.7831314921227388, 0.8963923327088348, 2.644225079252578))}
        ...
        expected_xyz = {
            'symbols': ('C', 'C', 'O', 'O', 'H', 'H', 'H', 'H', 'H', 'H', 'C', 'C', 'H', 'H', 'H', 'H', 'H'),
            'isotopes': (12, 12, 16, 16, 1, 1, 1, 1, 1, 1, 12, 12, 1, 1, 1, 1, 1),
            'coords': ((1.2649859300230701, 0.13759962369910417, -2.440447531798377), (1.2649859300230701, 0.13759962369910417, -0.9256995545416022), (0.10473538147993366, 0.831255835571242, -0.4698815895025732), (0.1712065743184885, 0.7912942631652592, 0.9839765919621501), (1.2649859300230701, 1.1624382440753973, -2.826162153012552), (2.1417656292382556, -0.386574333976476, -2.8308190477862984), (0.36224962532010685, -0.34754575801939763, -2.8261235962638875), (2.1601978847900676, 0.6424012642179907, -0.5474010650946814), (1.244147698156431, -0.889961845920296, -0.5475235100202871), (-0.8131944682789223, 0.18068899621880896, 1.1406698750507478), (-1.1441747795569157, -1.2446211648952852, 2.024371904873758), (-1.6786288710470962, -0.7100244131080616, 0.7148466196296459), (-1.607238953816066, -2.206317857332428, 2.2645923313981497), (-1.3566012910045397, -0.5467562979122979, 2.8397702744038837), (-0.061089002496746536, -1.3884564394281649, 1.9674300047899096), (-2.7617218427657386, -0.5661944869066785, 0.7717888662839982), (-1.4662023303702527, -1.4078892646301615, -0.10055175551803908))}
        self.assertTrue(almost_equal_coords(ts_xyz, expected_xyz))
