...
H       4.77508221   -0.06185183    0.53448907""")
    ...
    def test_heuristics_for_hydrolysis(self):
        ...
        methanol = self.methanol
        rxn2 = ARCReaction(r_species=[ethyl_methylether, water], p_species=[ethanol, methanol])
        heuristics_2 = HeuristicsAdapter(job_type='tsg',
                                        reactions=[rxn2],
                                        testing=True,
                                        project='test',
        ...
        self.assertEqual(rxn2.ts_species.ts_guesses[0].initial_xyz['symbols'], ('C', 'C', 'O', 'C', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'O', 'H', 'H'))
        ...
        heuristics_3.execute_incore()
        self.assertEqual(rxn3.family, 'imine_hydrolysis')
        self.assertTrue(rxn3.ts_species.is_ts)
        self.assertEqual(rxn3.ts_species.ts_guesses[0].initial_xyz['symbols'], ('C', 'C', 'C', 'C', 'C', 'C', 'C', 'N', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'O', 'H', 'H'))
        self.assertEqual(len(rxn3.ts_species.ts_guesses), 14)
        #Nitrile hydrolysis
        ...
        self.assertTrue(rxn4.ts_species.is_ts)
        self.assertEqual(rxn4.ts_species.ts_guesses[0].initial_xyz['symbols'],('N', 'C', 'C', 'C', 'N', 'H', 'H', 'O', 'H', 'H'))
