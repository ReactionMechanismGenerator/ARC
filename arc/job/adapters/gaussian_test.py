...
class TestGaussianAdapter(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.job_10 = GaussianAdapter(execution_type='local',
                            ...
                            species=[ARCSpecies(label='anion', xyz=['O 0 0 1'], charge=-1, is_ts=False)],
                            testing=True,
                            args={'trsh': {'trsh': 'Acc2E=14'}},
                            )

        # Need to setup trsh for job_11
                # Test Gaussian
        label = 'anion'
...
"""
    ...
    def test_trsh_write_input_file(self):
        ...
        1. Test with getting Acc2E14 as the trsh method and thus changing the input file integral algorithm
...
#P opt=(calcfc, tight, maxstep=5) uwb97xd  scf=(tight, direct) integral=(grid=ultrafine, Acc2E=14) IOp(2/9=2000) scf=xqc   
