...
ts_adapters_by_rmg_family = {'1+2_Cycloaddition': ['kinbot'],
                             ...
                             '1,2_shiftC': ['gcn', 'qst2'],
                             '1,2_shiftS': ['gcn', 'kinbot', 'qst2'],
                             '1,3_Insertion_CO2': ['kinbot'],
                             '1,3_Insertion_ROR': ['kinbot'],
                             '1,3_Insertion_RSR': ['kinbot'],
                             '1,4_Cyclic_birad_scission': ['gcn', 'qst2'],
                             '2+2_cycloaddition_CCO': ['kinbot'],
                             '2+2_cycloaddition_CO': ['kinbot'],
                             '2+2_cycloaddition_CS': ['kinbot'],
                             '2+2_cycloaddition_Cd': ['kinbot'],
                             '6_membered_central_C-C_shift': ['gcn', 'qst2'],
                             'Concerted_Intra_Diels_alder_monocyclic_1,2_shiftH': ['gcn', 'qst2'],
                             'Cyclic_Ether_Formation': ['kinbot'],
                             'Cyclopentadiene_scission': ['gcn', 'qst2'],
                             'Diels_alder_addition': ['kinbot'],
                             'H_Abstraction': ['heuristics', 'autotst'],
                             'HO2_Elimination_from_PeroxyRadical': ['kinbot'],
                             'Intra_2+2_cycloaddition_Cd': ['gcn', 'qst2'],
                             'Intra_5_membered_conjugated_C=C_C=C_addition': ['gcn', 'qst2'],
                             'Intra_Diels_alder_monocyclic': ['gcn', 'kinbot', 'qst2'],
                             'Intra_Disproportionation': ['gcn', 'qst2'],
                             'Intra_ene_reaction': ['gcn', 'kinbot', 'qst2'],
                             'intra_H_migration': ['autotst', 'gcn', 'kinbot', 'qst2'],
                             'intra_NO2_ONO_conversion': ['gcn', 'qst2'],
                             'intra_OH_migration': ['gcn', 'kinbot', 'qst2'],
                             'Intra_RH_Add_Endocyclic': ['gcn', 'kinbot', 'qst2'],
                             'Intra_RH_Add_Exocyclic': ['gcn', 'kinbot', 'qst2'],
                             'Intra_R_Add_Endocyclic': ['gcn', 'kinbot', 'qst2'],
                             'Intra_R_Add_Exo_scission': ['gcn', 'qst2'],
                             'Intra_R_Add_Exocyclic': ['gcn', 'kinbot', 'qst2'],
                             'Intra_R_Add_ExoTetCyclic': ['kinbot'],
                             'Intra_Retro_Diels_alder_bicyclic': ['kinbot'],
                             'intra_substitutionCS_isomerization': ['gcn', 'qst2'],
                             'intra_substitutionS_isomerization': ['gcn', 'qst2'],
                             'ketoenol': ['gcn', 'kinbot', 'qst2'],
                             'Korcek_step1': ['gcn', 'qst2'],
                             'Korcek_step2': ['kinbot'],
                             'R_Addition_COm': ['kinbot'],
                             'R_Addition_CSm': ['kinbot'],
                             'R_Addition_MultipleBond': ['autotst', 'kinbot'],
                             'Retroene': ['kinbot'],
                             'Singlet_Carbene_Intra_Disproportionation': ['gcn', 'qst2'],
                             }
