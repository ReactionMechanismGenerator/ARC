...
from arc.molecule.group import Group, ActionError
...
""",
    ...
    def test_get_symmetry_number(self):
        ...
        self.assertEqual(12, mol.get_symmetry_number())

        empty = Molecule()
        self.assertEqual(1, empty.get_symmetry_number())
...
86 H u0 p0 c0 {13,S}
    ...
    def test_to_group(self):
        ...
        self.assertEqual(len(mol.atoms), len(group.atoms))
        ...
        self.assertEqual(molbondcount, groupbondcount)
    ...
    def test_to_adjacency_list_with_isotopes(self):
        ...
        self.assertEqual(adjlist, adjlist_exp)
