...
from arc.molecule.pathfinder import (compute_atom_distance, find_adj_lone_pair_multiple_bond_delocalization_paths,
...
8 H u0 p0 c0 {1,S}
        ...
        self.assertEqual(idx_paths, expected_idx_paths)
