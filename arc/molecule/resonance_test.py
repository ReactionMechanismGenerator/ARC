...
class ResonanceTest(unittest.TestCase):
    ...
    def test_allyl_shift(self):
        ...
        mol_list = generate_resonance_structures(Molecule(smiles="C[CH]C=CC"))
        self.assertEqual(len(mol_list), 1)

        mol_list = generate_resonance_structures(Molecule(smiles="C[CH]C=CC"), keep_isomorphic=True)
    ...
    def test_n5dc_radical(self):
        ...
        self.assertEqual(isomorphic_counter, 2)
        self.assertEqual(negatively_charged_nitrogen, 2)
