...
"""
    ...
    def test_make_sample_atom(self):
        ...
        self.assertEqual(new_atom.element, elements.__dict__['C'])
        self.assertEqual(new_atom.radical_electrons, 1)
        self.assertEqual(new_atom.charge, 0)
        self.assertEqual(new_atom.lone_pairs, 0)
...
"""
        ...
        self.assertEqual(len(cbfAtomList), 0)
...
"""
        ...
        self.assertEqual(len(cbfAtomList), 1)
        self.assertEqual(len(cbfAtomList1), 1)
...
"""
        ...
        self.assertEqual(len(cbfAtomList1), 2)
        self.assertEqual(len(cbfAtomList2), 1)
        self.assertEqual(len(cbAtomList), 5)
...
"""
        ...
        self.assertEqual([x.label for x in ordered_atoms], ["*1", "*3", "*2"])
...
"""
        ...
        self.assertEqual([x.label for x in ordered_atoms], ["*1", "*3", "*4", "*2", "*5"])
