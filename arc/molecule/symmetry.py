...
def calculate_axis_symmetry_number(molecule):
    ...
    If an end has 0 or 1 groups (e.g., =C=CJJ or =C=C-R) then it cannot
    ...
    If an end has 2 different groups, then it breaks the symmetry
    ...
    for bonds in cumulated_bonds:
        ...
        # Split the remaining fragments of the structure
        ...
        for fragment in end_fragments:  # a fragment is one end of the axis
            ...
            # If the end has only one group, then it can't contribute to (nor break) axial symmetry
            #   E.g., this has no axis symmetry: A-T=C=C=C=T-A
        ...
        NB>> This assumes coordination number of 4 (e.g., Carbon).
...
def calculate_cyclic_symmetry_number(molecule):
    ...
    # Get the symmetry number for each ring in structure and multiply
    for ring in single_rings:
        ...
        for flipping_atom_index in flipping_atom_indexes:
            ...
            while min_index <= max_index:
                ...
                # of the list when the index is out of bounds
