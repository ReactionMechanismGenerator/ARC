...
from arc.molecule.graph import Graph, Vertex
from arc.molecule.molecule import Atom, Bond, Molecule
from arc.molecule.atomtype import get_atomtype, AtomTypeError, ATOMTYPES, AtomType
...
class Fragment(Molecule):
    ...
    def detect_cutting_label(self, smiles):
        import re
        from arc.molecule.element import element_list
