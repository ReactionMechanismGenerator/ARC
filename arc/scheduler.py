...
LOWEST_MAJOR_TS_FREQ, HIGHEST_MAJOR_TS_FREQ, default_incore_adapters, default_job_settings, \
    default_job_types, rotor_scan_resolution, ts_adapters, max_rotor_trsh = \
    settings['LOWEST_MAJOR_TS_FREQ'], settings['HIGHEST_MAJOR_TS_FREQ'], settings['default_incore_adapters'], \
    settings['default_job_settings'], settings['default_job_types'], settings['rotor_scan_resolution'], \
    settings['ts_adapters'], settings['max_rotor_trsh']
