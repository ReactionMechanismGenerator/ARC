...
class TestARCReaction(unittest.TestCase):
    ...
    def test_get_atom_map_wip(self):
        ...
        These are FAILING tests that should be fixed by implementing additions to mapping algorithem
        for example, fixes to cyclic molecule scission in mapping.
        """

        # 1+2_Cycloaddition: CH2 + C2H4 <=> C3H6 wait until support cyclic molecule mapping.
