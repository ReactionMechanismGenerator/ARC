...
class ARCReaction(object):
    ...
    def get_bonds(self) -> Tuple[List[Tuple[int, int]], List[Tuple[int, int]]]:
        """
        Get the connectivity of the reactants and products, all mapped to the indices of the reactants.
