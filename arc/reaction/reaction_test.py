...
4 H u0 p0 c0 {1,S}""",
    ...
    def test_get_atom_map(self):
        ...
        rxn = ARCReaction(reactants=['NH', 'N2H3'], products=['NH2', 'N2H2(T)'],
                          r_species=[r_1, r_2], p_species=[p_1, p_2])
        self.assertEqual(self.rxn12.atom_map[0], 0)  # todo: why None?
        self.assertEqual(rxn.atom_map[0], 0)  # todo: why None?  what's the difference between this and the rxn above??
