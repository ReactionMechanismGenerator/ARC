...
class TestARCReaction(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.rxn1 = ARCReaction(r_species=[ARCSpecies(label='CH4', smiles='C'), ARCSpecies(label='OH', smiles='[OH]')],
                               p_species=[ARCSpecies(label='CH3', smiles='[CH3]'), ARCSpecies(label='H2O', smiles='O')])
        cls.rxn2 = ARCReaction(r_species=[ARCSpecies(label='C2H5', smiles='C[CH2]'), ARCSpecies(label='OH', smiles='[OH]')],
                               p_species=[ARCSpecies(label='C=C', smiles='C2H4'), ARCSpecies(label='H2O', smiles='O')])
        cls.rxn3 = ARCReaction(r_species=[ARCSpecies(label='CC[NH]', smiles='CH3CH2NH')],
                               p_species=[ARCSpecies(label='[CH2]CH', smiles='CH2CH2NH2')])
        cls.rxn4 = ARCReaction(r_species=[ARCSpecies(label='NH2', smiles='[NH2]'), ARCSpecies(label='N[NH]', smiles='NH2NH')],
                               p_species=[ARCSpecies(label='NH3', smiles='N'), ARCSpecies(label='N[N]', smiles='NH2N')])
