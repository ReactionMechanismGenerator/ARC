...
def get_ordered_intersection_of_two_lists(l1: list,
    ...
    Args:
        l1: The first list.
        l2: The second list.
        order_by_first_list: Whether to order the output list using the order of the values in the first list.
        return_unique: Whether to return only unique values in the intersection of two lists.
...
# see https://gaussian.com/overlay3/#iop_(3/74) for more info on g16 methods
g16_supported_methods = ['uff',  # mechanics
                         'dreiding',
                         'amber',
                         'pm6',  # semi-empirical
                         'pddg',
...
# see http://www.q-chem.com/qchem-website/manual/qchem51_manual/sect-XCfuncs.html for more info on qchem methods
qchem_supported_methods = ['B97-D3',
                           'DFT_D D3_BJ',
                           'BLYP',
                           'B3LYP',
                           'DFT_D D3_BJ',
...
# see http://www.petachem.com/doc/userguide.pdf for more info on terachem methods
terachem_supported_methods = ['rhf',
                              'svwn',
                              'bhandhlyp',
                              'blyp',
                              'b3lyp',
