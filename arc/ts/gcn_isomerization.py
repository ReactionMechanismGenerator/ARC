...
`git clone https://github.com/PattanaikL/ts_gen_v2.git`

2) Add `ts_gen_v2` to your PYTHONPATH

3) Install PyTorch Geometric in the `arc_env` via
https://pytorch-geometric.readthedocs.io/en/latest/notes/installation.html
Alternatively, run `make conda_env_arc` from the home directory of `ts_gen_v2`
to create a new environment compatible with both repositories.
...
def gcn_isomerization(reactions):
    ...
    #todo: figure out how to pass these TS guess xyz coordinates to a QM submission script
    # try following what happens to user_guess for an ARC reaction...
