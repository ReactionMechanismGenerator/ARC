...
12 H u0 p0 c0 {6,S}"""
    ...
    def test_check_zmat_vs_coords(self):
        ...
        coords = np.array([[-2.4050857575832123, 2.082149685245476e-08, -0.03557225452565956],
        ...
        self.assertFalse(zmat.check_zmat_vs_coords(zmat1, coords, rtol=0.05, atol=1e-4))
