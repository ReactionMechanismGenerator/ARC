...
O      -1.40465894   -0.03095532    0.00000000""")
        ...
        self.assertAlmostEqual(angle, 117.02817, 2)
    ...
    def test_calculate_param(self):
        ...
        self.assertAlmostEqual(angle, 125.183443, places=2)
