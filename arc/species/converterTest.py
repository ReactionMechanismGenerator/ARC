...
from arc.common import almost_equal_coords_lists, almost_equal_lists, read_xyzs
...
def test_calc_rmsd_wrapper(self):
    ...
    diels_alder_product = {
        'symbols': ('C', 'C', 'C', 'C', 'H', 'H', 'H', 'H', 'H', 'H', 'C', 'C', 'H', 'H', 'H', 'H'),
    ...
    # check that 2 identical molecules with shuffled atom order have 0 rmsd and their sorted dictionaries are identical
    reactant1_xyz, reactant2_xyz, product1_xyz, product2_xyz, rmsd = converter.calc_rmsd_wrapper(
        reactant1_xyz=water,
    ...
    reactant1_xyz, reactant2_xyz, product1_xyz, product2_xyz, rmsd_ordered = converter.calc_rmsd_wrapper(
        bicyclo_2_1_1_hexane,
        hexa_1_5_diene)
    self.assertEqual(reactant1_xyz['symbols'], product1_xyz['symbols'])
    reactant1_xyz, reactant2_xyz, product1_xyz, product2_xyz, rmsd_shuffled = converter.calc_rmsd_wrapper(
        bicyclo_2_1_1_hexane,
        hexa_1_5_diene_shuffled)
    self.assertEqual(reactant1_xyz['symbols'], product1_xyz['symbols'])
    ...
    reactant1_xyz, reactant2_xyz, product1_xyz, product2_xyz, rmsd_ordered = converter.calc_rmsd_wrapper(
        reactant1_xyz=diels_alder_reactant1,
