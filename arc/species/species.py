...
class ARCSpecies(object):
    ...
    Args:
        ...
        compute_thermo (bool, optional): Whether ot not to calculate thermodynamic properties for this species.
    ...
    Attributes:
        ...
        compute_thermo (bool): Whether ot not to calculate thermodynamic properties for this species.
    ...
    def __init__(self, label=None, is_ts=False, rmg_species=None, mol=None, xyz=None, multiplicity=None, charge=None,
        ...
        if species_dict is not None:
            ...
            self.chosen_ts = None
            self.compute_thermo = compute_thermo if not self.is_ts else False
    ...
    def from_dict(self, species_dict):
        ...
        if 'charge' not in species_dict:
            logger.debug(f'No charge specified for {self.label}, assuming charge 0.')
        if self.is_ts:
            self.compute_thermo = False
        else:
            self.compute_thermo = species_dict['compute_thermo'] if 'compute_thermo' in species_dict else True
