...
def calc_rmsd_wrapper(reactant1_xyz: dict,
    ...
    Order the product atoms in the same order as the reactant atoms by minimizing the RMSD.
    ...
    Args:
        ...
        xyz_file_name (str): Filename when creating the .xyz file for DE GSM.
    ...
    xyz = str(p_size) + '\n' + '\n' + '\n'.join(xyz_reactant) + '\n'
    xyz += str(q_size) + '\n' + '\n' + reordered_product_xyz_str + '\n'
    # write the xyz file used for DE GSM
    if xyz_file_name:
