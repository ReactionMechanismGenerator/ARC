"""
This is the driver part of the atom mapping module.
...
Strategy:
    ...
    3) If the reaction is supported by RMG, it is sent to the engine. Otherwise, it is mapped with map_general_rxn.
"""
...
def map_isomerization_reaction(rxn: 'ARCReaction',
    ...
    Returns:
        Optional[List[int]]:
            ...
            corresponding entry values are running atom indices of the products.
    """
    # Check if this is a ring opening reaction (only one bond scission occurs).
