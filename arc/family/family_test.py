...
H      -0.83821148   -0.26602407    0.00000000"""
    ...
    def test_get_reaction_family_products_cyclic_ether_formation(self):
        ...
        expected_products = [{'discovered_in_reverse': False,
                              ...
                              'group_labels': 'R2OO',
                              'r_label_map': {'*1': 0, '*2': 3, '*3': 4, '*4': 1},
                              'p_label_map': {'*1': 2, '*2': 5, '*3': 1, '*4': 3},
                              'own_reverse': False,
    ...
    def test_determine_possible_reaction_products_from_family(self):
        ...
        expected_product_dicts = [{'discovered_in_reverse': False,
                                   'family': 'intra_H_migration',
                                   'group_labels': 'R3Hall',
                                   'r_label_map': {'*1': 0, '*4': 1, '*2': 2, '*3': 7},
                                   'p_label_map': {'*1': 0, '*2': 2, '*3': 7, '*4': 1},
                                   'own_reverse': True,
                                   'products': [Molecule(smiles="[CH2]CC")]},
                                  {'discovered_in_reverse': False,
                                   'family': 'intra_H_migration',
                                   'group_labels': 'R3Hall',
                                   'r_label_map': {'*1': 0, '*4': 1, '*2': 2, '*3': 8},
                                   'p_label_map': {'*1': 0, '*2': 2, '*3': 8, '*4': 1},
                                   'own_reverse': True,
                                   'products': [Molecule(smiles="[CH2]CC")]},
                                  {'discovered_in_reverse': False,
                                   'family': 'intra_H_migration',
                                   'group_labels': 'R3Hall',
                                   'r_label_map': {'*1': 0, '*4': 1, '*2': 2, '*3': 9},
                                   'p_label_map': {'*1': 0, '*2': 2, '*3': 9, '*4': 1},
                                   'own_reverse': True,
                                   'products': [Molecule(smiles="[CH2]CC")]},
                                  {'discovered_in_reverse': False,
                                   'family': 'intra_H_migration',
