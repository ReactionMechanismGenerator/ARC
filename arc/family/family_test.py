...
H      -0.83821148   -0.26602407    0.00000000"""
    ...
    def test_check_product_isomorphism(self):
        ...
        products = [Molecule(smiles="[NH]N"), Molecule(smiles="[NH-][NH2+]")]  # it's N2H3, just a diff resonance structure
        p_species = [ARCSpecies(label="P1", smiles="N[NH]", is_ts=False, multiplicity=2, charge=0),
                     ARCSpecies(label="P2", smiles="N[NH]", is_ts=False, multiplicity=2, charge=0)]  # todo: make this pass, retest H abstraction heuristics
