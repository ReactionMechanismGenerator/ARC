...
def _read_irc_geometry_table(lines: list[str], start: int) -> tuple[dict | None, int]:
    ...
    closing dashed line or the end of the file. Rows whose atomic number or
    coordinates are not numeric are skipped.
    ...
    Returns: tuple[dict | None, int]
        The geometry as an ARC xyz dict, or ``None`` when the table holds no
        atoms, and the index of the line that terminated the table.
    """
    i = start
    separator_count = 0
